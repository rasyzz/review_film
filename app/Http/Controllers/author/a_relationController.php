...
class a_relationController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('author.relasi.index', compact('film', 'genre', 'gl',));
    }
    /**
    ...
    public function create()
    {
        ...
        return view('author.relasi.create', compact('films', 'genres'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('a.relasi.index')->with('success', 'Genre berhasil ditambahkan!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('author.relasi.update', compact('film', 'filmList', 'genre', 'selectedGenres'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('a.relasi.index')->with('success', 'Data genre berhasil diperbarui!');
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('a.relasi.index')->with('success', 'Semua genre terkait berhasil dihapus.');
        } catch (\Exception $e) {
            return redirect()->route('a.relasi.index')->with('error', 'Data tidak ditemukan atau terjadi kesalahan.');
        }
    }
}
